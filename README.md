...
3. I have a small number of patients, I want to use Metient's pancancer calibrated wegiths, or I want to enforce my own parsimony metric weights. (Metient-evaluate)
