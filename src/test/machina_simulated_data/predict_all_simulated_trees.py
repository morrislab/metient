...
for site in sites:
    ...
    for mig_type in mig_types:
        ...
        for seed in seeds:
            ...
            python_cmd = [f"bsub -J metient_sim_{site}_{mig_type}_{seed} -n 8 -W {time}  -R rusage[mem=8] -o output_metient_sims.log -e error_metient_sims.log ./predict_single_simulated_tree.sh",
