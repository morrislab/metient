...
def predict_vertex_labelings(machina_sims_data_dir, site, mig_type, seed, out_dir, results):
    #print("="*150)
    ...
    for adj_matrix, pruned_cluster_label_to_idx in data:
        ...
        weights = vertex_labeling.Weights(data_fit=0.8, mig=10.0, comig=5.0, seed_site=1.0, reg=1.0, gen_dist=0.5)
    ...
    for site in sites:
        ...
        for mig_type in mig_types:
            ...
            for seed in seeds:
                ...
                futures.append(executor.submit(predict_vertex_labelings, machina_sims_data_dir, site, mig_type, seed, out_dir, results))
