...
def predict_vertex_labeling(machina_sims_data_dir, site, mig_type, seed, tree_num, out_dir, weights, batch_size, weight_init_primary, lr_sched):
    ...
    adj_matrix, pruned_cluster_label_to_idx = data_util.get_adj_matrices_from_all_mutation_trees(all_mut_trees_fn, cluster_label_to_idx, is_sim_data=True)[tree_num]
...
if __name__=="__main__":
    ...
    parser.add_argument('--tree_num', type=int, help="clone tree number")
